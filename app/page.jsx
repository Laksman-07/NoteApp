...
export default function Home() {
  return (
    ...
    <h2 className='m-4 font-bold'>Updates</h2>

    <div className="card">
      <h3 className='mb-5 font-semibold'>New member of the web dev team...</h3>
    ...
    <div className="card">
      <h3 className='mb-5 font-semibold'>New website live!</h3>
